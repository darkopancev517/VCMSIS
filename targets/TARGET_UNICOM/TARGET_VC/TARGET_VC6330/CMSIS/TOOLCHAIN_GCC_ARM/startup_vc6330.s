/**************************************************************************//**
 * @file     startup_vc6330.s
 * @brief    CMSIS-Core(M) Device Startup File for VC6330 Cortex-M3 Device
 * @version  V1.0.0
 * @date     30. June 2021
 ******************************************************************************/
/*
...
__Vectors:
                ...
                .long    HASH_Handler                       /*  31 HASH Handler */
                .long    PLC_DMA_Handler                    /*  32 PLC DMA Handler */
                .long    PLC_MAC_Handler                    /*  33 PLC MAC Handler */
                .long    PHY_Handler                        /*  34 PHY Handler */
                .long    ETHERNET_MAC_Handler               /*  35 ETHERNET MAC Handler */
                .long    I2C2_Handler                       /*  36 I2C2 Handler */
                .long    ETHERNET_Handler                   /*  37 ETHERNET Handler */
                .long    GPIO_Handler                       /*  38 GPIO Handler */
                .long    PKE_Handler                        /*  39 PKE Handler */
                .long    SKE_Handler                        /*  40 SKE Handler */
                .long    SD_Handler                         /*  41 SD Handler */
                .long    TRNG_Handler                       /*  42 TRNG Handler */

                .space   (5 * 4)                           /* Interrupts 43 .. 48 are left out */
__Vectors_End:
...
/* Default exception/interrupt handler */
                ...
                Set_Default_Handler  HASH_Handler
                Set_Default_Handler  PLC_DMA_Handler
                Set_Default_Handler  PLC_MAC_Handler
                Set_Default_Handler  PHY_Handler
                Set_Default_Handler  ETHERNET_MAC_Handler
                Set_Default_Handler  I2C2_Handler
                Set_Default_Handler  ETHERNET_Handler
                Set_Default_Handler  GPIO_Handler
                Set_Default_Handler  PKE_Handler
                Set_Default_Handler  SKE_Handler
                Set_Default_Handler  SD_Handler
