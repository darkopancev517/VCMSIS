...
/* centauri notify gpio pin */
#define CENTAURI_HOSTIF_TRIG_OFF                0
#define CENTAURI_HOSTIF_TRIG_GPIO0              0
...
#define VALID_RX_LEN_MAX	        (VC_RADIO_MAX_BUFFER_SIZE + 4)          // 4: is FCS SIZE
