...
/*----------------------------------------------------------------------------
  Define clocks
 *----------------------------------------------------------------------------*/
#define SYSTEM_CLOCK        (150000000) /* 150 MHz */
...
void SystemInit(void)
{
  ...
  /* Set clock using gppll 150MHz */
  vcana_set_gppll_150mhz();

  /* Set AHB clock divider to 1: AHB clock 150 MHz */
  temp = VC_MISC2->CLKDIVH;
  temp &= ~VC_MISC2_CLKDIVH_CLKDIVH_Msk;
  temp |= VC_MISC2_CLKDIVH_CLKDIVH_DIV(1);
  VC_MISC2->CLKDIVH = temp;

  /* Set APB clock divider to 4: APB clock 37.5 MHz*/
