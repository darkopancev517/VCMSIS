...
void MSGBOX_Handler         (void) __attribute__ ((weak, alias("Default_Handler")));
void BPDET_Handler          (void) __attribute__ ((weak, alias("Default_Handler")));
...
extern const VECTOR_TABLE_Type __VECTOR_TABLE[64];
  ...
  MSGBOX_Handler,                       /*  38 MSGBOX Handler */
  0,                                    /*     Reserved */
  BPDET_Handler,                        /*  40 BPDET Handler */
  SDIO_Handler,                         /*  41 SDIO Handler */
};
