...
<head>
<meta charset="utf-8">
<title>Intra2net Security Gateway - Download</title>
...
<a href="download_gateway.php#navigation"><div class="mobilemenu"><img src="../pictures/mobile_icon.gif" alt="Navigation"></div></a>
<a href="download_gateway.php#"><div class="mobilemenu"><img src="../pictures/mobile_icon.gif" alt="Navigation"></div></a>
...
<h1>Intra2net Security Gateway - Download</h1>

<div class="grid">

	<div class="col-40 left">
		<img src="../pictures/intra2net-security-gateway.jpg" alt="Intra2net Security Gateway">
	</div>

	<div class="col-60 margintop right">
		
            <form action="download_gateway.php" method="post" name="standardform" id="standardform">
