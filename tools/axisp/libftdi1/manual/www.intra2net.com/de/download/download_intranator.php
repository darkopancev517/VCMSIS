...
<head>
<meta charset="utf-8">
<title>Intra2net Business Server - Download</title>
...
<a href="download_intranator.php#navigation"><div class="mobilemenu"><img src="../pictures/mobile_icon.gif" alt="Navigation"></div></a>
<a href="download_intranator.php#"><div class="mobilemenu"><img src="../pictures/mobile_icon.gif" alt="Navigation"></div></a>
...
<h1>Intra2net Business Server - Download</h1>

<div class="grid">

	<div class="col-40 left">
		<img src="../pictures/intra2net-business-server.jpg" alt="Intra2net Business Server">
	</div>

	<div class="col-60 margintop right">
		
            <form action="download_intranator.php" method="post" name="standardform" id="standardform">
             <table class="long_form">
                          <tr><th colspan="2"><h2>Jetzt 30 Tage kostenlos testen</h2></th></tr>
             <tr><td></td><td style="padding: 0px;"><img src="../pictures/form_pointer.gif" style="display: block;"></td></tr>
              ...
              <tr>
                  <td valign="top">Ihr Name<span class="required">*</span>
                  </td>
                  <td class="data">
                  <select name="address">
	<option value="Herr">Herr</option>
	<option value="Frau">Frau</option>
</select> <input size="22" maxlength="255" name="name" type="text" />
                  </td>
              </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td class="data">
                  <input class="submitbutton" value="Download starten" type="submit" />
                  </td>
